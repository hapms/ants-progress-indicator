...
namespace Hapoom.AntsProgressIndicator
{
    ...
    public class AntsProgressIndicator : Control
    {
        Rectangle  _ant1;
        Rectangle  _ant2; 
        Rectangle  _ant3;
        ...
        {
            var bi = (AntsProgressIndicator)d;
